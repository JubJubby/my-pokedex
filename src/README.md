This is a basic app that displays a list of items (Pokemon) pulled from an API (Pokemon API) with functionality to view further details (an image of the pokemon, its height, weight, and types) in a modal when that item is interacted with.

To do:

- [ ] Add search function by name
- [ ] Add filter options by typing, height, and weight
